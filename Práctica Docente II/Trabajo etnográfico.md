Ver una determinada realidad y sacar conclusiones
Conclusión = diagnóstico institucional
Ver ciertas dimensiones dentro de una institución escolar

Herramientas:
	Entrevistas (12) a directivo, docentes (entre 3 y 6 docentes, cubrir roles que no estén), preceptores (2, uno de cada ciclo, más antigüedad es mejor), no docentes (maestranza), bibliotecario si hay, coordinador de cursos, gabinete, secretario, ayudante técnico.

1) ¿Qué rol desempeñas en la institución? ¿Hace cuánto tiempo? - Es parte del encabezado.
...
Consigna
Introducción a la institución observada
Croquis
